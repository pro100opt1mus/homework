...
const pro100opt1mus::MenuItem *MenuFunctions::show_global_menu(const pro100opt1mus::MenuItem *current) {
...
const pro100opt1mus::MenuItem *MenuFunctions::show_element_menu(const pro100opt1mus::MenuItem *current) {
    std::cout << current->title << ": " << std::endl;

    return show_global_menu(current);
};

const pro100opt1mus::MenuItem *MenuFunctions::show_element_with_link_menu(const pro100opt1mus::MenuItem *current) {
    std::cout << current->title << ": " << std::endl;
